...
export default function CustomerFormModal({
  ...
  function validate(): { ok: boolean; switchTo?: TabKey; firstError?: string } {
    ...
    const infoFields: (keyof FormData)[] = [
      ...
      'alternate_number_2', 'aadhaar', 'address', 'model_no', 'imei', 'box_no',
    ];
  ...
  const infoErrCount = ['retailer_id','customer_name','mobile','alternate_number_1',
    'alternate_number_2','aadhaar','address','model_no','imei','box_no']
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                    ...
                    <F label="Landmark" field="landmark"
                       form={form} set={set} errors={errors} placeholder="Nearby landmark (optional)" />
                  </div>
                </section>
